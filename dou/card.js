...
function compareCards(cards1, cards2) {
  ...
  if (type1 === cardTypes.STRAIGHT) {
    ...
    //return getCardValue(cards1[0]) - getCardValue(cards2[0]);
	let cards01 = [...cards1].sort((a,b)=>getCardValue(a)-getCardValue(b));
	let cards02 = [...cards2].sort((a,b)=>getCardValue(a)-getCardValue(b));
	return getCardValue(cards01[0]) - getCardValue(cards02[0]);
	//
  }
